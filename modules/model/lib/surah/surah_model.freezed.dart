...
class _$_SurahModel implements _SurahModel {
  ...
  @override
  String toString() {
    return 'SurahModel(number: $number, sequence: $sequence, numberOfVerses: $numberOfVerses, name: $name, revelation: $revelation, tafsir: $tafsir)';
  }
...
abstract class _SurahModel implements SurahModel {
  const factory _SurahModel(
      ...
      final Name? name,
      final Revelation? revelation,
      final Tafsir? tafsir}) = _$_SurahModel;
...
class _$_Translation implements _Translation {
  const _$_Translation({required this.en, required this.id});
...
abstract class _Translation implements Translation {
  const factory _Translation(
      {required final String en, required final String id}) = _$_Translation;
...
class _$_Transliteration implements _Transliteration {
  const _$_Transliteration({required this.en, required this.id});
